...
<hr>
    <div class="row">
        <div class="col-12 pt-2 show">
            <a href="{{ route('blog.index')}}" class="btn btn-outline-primary btn-sm">@lang('lang.text_return')</a>
            ...
            <p>
                <strong>@lang('lang.text_blog_author'): </strong> {{ $blogPost->blogHasUser->name }}
            </p>
        </div>
    </div>
    <hr>
    <div class="row mb-5">
        <div class="col-6">
            <a href="{{route('blog.edit', $blogPost->id)}}" class="btn btn-primary">@lang('lang.text_update')</a>
        </div>
        <div class="col-6">
